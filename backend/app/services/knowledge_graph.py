...
class KnowledgeGraphService:
    ...
    def __init__(self, storage_path: str = None):
        ...
        self.neo4j_store = self._create_neo4j_store()
    ...
    def add_entity(self, entity_type: str, name: str, properties: Dict = None) -> str:
        ...
        entity_id = self._build_entity_id(entity_type, name, properties)
        ...
        self.neo4j_store.upsert_entity(entity_id, self.entities[entity_id])
        return entity_id
    ...
    def add_relation(self, source_id: str, relation_type: str, target_id: str, properties: Dict = None):
        ...
        self.neo4j_store.upsert_relation(source_id, relation_type, target_id, properties or {})
    ...
    def export_graph(self) -> Dict:
        ...
        return {
            ...
            'stats': {
                ...
                'storage': {
                    'local_json': True,
                    'neo4j': self.neo4j_store.get_stats()
                }
            }
        }
    ...
    def _save(self):
        ...
        self.neo4j_store.sync_graph(self.entities, self.relations)
    ...
    def _create_neo4j_store(self) -> Neo4jGraphStore:
        """创建 Neo4j 存储适配器。"""
        if has_app_context():
    ...
    @staticmethod
    def _build_entity_id(entity_type: str, name: str, properties: Dict) -> str:
        """基于实体类型、名称和关键属性构造稳定且不冲突的实体 ID。"""
        payload = json.dumps({
            'type': entity_type,
            'name': name,
            'properties': properties
