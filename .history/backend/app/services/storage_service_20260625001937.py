...
class MinIOStorage:
    ...
    def __init__(self, endpoint=None, access_key=None, secret_key=None,
        ...
        self._client = None
        self._unavailable = False  # 标记MinIO不可用，避免重复检测
    ...
    def _get_client(self):
        ...
        if self._client is None:
            ...
            try:
                ...
                host = host_port[0]
                port = int(host_port[1]) if len(host_port) > 1 else (443 if self.secure else 9000)
                ...
                try:
                    ...
                    logger.warning(f"MinIO端口 {host}:{port} 不可达，回退到本地文件存储")
