<template>
  <div class="validation-center tech-page">
    <el-card class="val-hero">
      <div class="hero-row">
        <div>
          <div class="hero-badge">QUALITY VALIDATION</div>
          <h2 class="hero-title">质量验证</h2>
        </div>
      </div>
    </el-card>
    ...
    <el-row :gutter="20">
      <el-col :span="12">
        <el-card>
          <template #header><span>文档验证</span></template>
          <el-form :model="formData" label-width="80px">
            <el-form-item label="选择文档">
              <el-select v-model="formData.document_id" placeholder="选择要验证的文档" filterable>
    ...
    <el-card v-if="validationResult" style="margin-top: 20px">
      <template #header><span>验证详情</span></template>
      <el-table :data="validationResult.details" stripe>
    ...
    <el-card style="margin-top: 20px">
      ...
      <el-table :data="rules" stripe max-height="400">
