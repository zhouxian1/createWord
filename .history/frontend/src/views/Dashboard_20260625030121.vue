  ...
  <div class="dashboard cyber-page circuit-bg">
    ...
    <el-row :gutter="16" style="margin-top: 16px">
      ...
      <el-col :span="12">
        <div class="holo-panel" style="padding: 20px;">
          <div class="panel-header">
            <span class="panel-title">系统功能模块</span>
            <div class="neon-divider"></div>
          </div>
...
const modules = [
  { name: '知识库构建', desc: '支持20+格式文档解析与语义索引', icon: 'Collection', color: '#00f0ff' },
  { name: '438C文档生成', desc: '一键/按章节/从代码生成', icon: 'EditPen', color: '#39ff14' },
  { name: '质量验证', desc: '章节完整性与要素合规性校验', icon: 'CircleCheck', color: '#ff2d95' },
  { name: '文档合稿排版', desc: '多文档合并与自动排版', icon: 'CopyDocument', color: '#b44dff' }
]
...
.stat-card--1 { animation-delay: 0.5s; }
.stat-card--2 { animation-delay: 1s; }
.stat-card--3 { animation-delay: 1.5s; }
