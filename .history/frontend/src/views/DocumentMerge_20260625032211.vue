<template>
  <div class="document-merge cyber-page circuit-bg">
    <div class="merge-hero holo-panel">
      <div class="hero-row">
        <div>
          <div class="cyber-badge">DOC MERGE</div>
          <h2 class="glitch-title" style="margin-top: 10px; font-size: 22px;">文档合稿</h2>
        </div>
    ...
    <el-card>
      ...
      <el-table :data="tasks" stripe>
        ...
        <el-table-column label="操作" width="180">
          <template #default="{ row }">
            <el-button size="small" text type="primary" @click="executeTask(row)" :disabled="row.status === 'running'">
              执行
            </el-button>
            <el-button size="small" text @click="downloadResult(row)" :disabled="row.status !== 'completed'">
              下载
            </el-button>
            <el-button size="small" text type="danger" @click="deleteTask(row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-card>
