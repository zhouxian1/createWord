  ...
  <div class="dashboard tech-page">
    <el-card class="hero-card">
      <div class="hero-content">
        <div>
          <div class="hero-tag">INTELLIGENT DOCUMENT COMMAND CENTER</div>
          <h2 class="hero-title">438C 文档智能生成与知识编织平台</h2>
          <p class="hero-desc">统一管理知识库、图谱、生成、验证与问答流程，让规范文档生产链路可追踪、可解释、可视化。</p>
        </div>
