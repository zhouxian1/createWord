<template>
  <div class="project-list cyber-page circuit-bg">
    <div class="proj-hero holo-panel">
      <div class="hero-row">
        <div>
          <div class="cyber-badge">PROJECT MANAGEMENT</div>
          <h2 class="glitch-title" style="margin-top: 10px; font-size: 22px;">项目管理</h2>
        </div>
      ...
      <el-table :data="projects" stripe>
        ...
        <el-table-column label="操作" width="140" fixed="right">
          <template #default="{ row }">
            <el-button size="small" text type="primary" @click="editProject(row)">编辑</el-button>
